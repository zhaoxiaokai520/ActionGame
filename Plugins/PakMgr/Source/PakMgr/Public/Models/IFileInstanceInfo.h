...
public:
	 ...
	 * @return Log entries.
	 */
	virtual const TArray<TSharedPtr<FFileItemInfo>>& GetLog() = 0;
	 ...
	 */
	virtual TSharedPtr<IFileInfo> GetOwnerSession() = 0;
...
public:
	 ...
	 * @return The delegate.
	 */
	DECLARE_EVENT_TwoParams(IFileInstanceInfo, FLogReceivedEvent, const TSharedRef<IFileInstanceInfo>&, const TSharedRef<FFileItemInfo>&);
	virtual FLogReceivedEvent& OnLogReceived() = 0;

public:

	/** Virtual destructor. */
	virtual ~IFileInstanceInfo() { }
};
