...
public:
	...
	/**
	  ...
	  */
	virtual const TArray<TSharedPtr<IFileInstanceInfo>>& GetSelectedInstances() const = 0;
	 ...
	 */
	virtual const TSharedPtr<IFileInfo>& GetSelectedSession() const = 0;
	 ...
	 */
	virtual void GetSessions( TArray<TSharedPtr<IFileInfo>>& OutSessions ) const = 0;
	 ...
	 */
	virtual bool IsInstanceSelected( const TSharedRef<IFileInstanceInfo>& Instance ) const = 0;
	 ...
	 */
	virtual bool SelectSession( const TSharedPtr<IFileInfo>& Session ) = 0;
	 ...
	 */
	virtual bool SetInstanceSelected( const TSharedRef<IFileInstanceInfo>& Instance, bool Selected ) = 0;

	virtual bool SetAddModule(FString& moduleName) = 0;

public:

	DECLARE_EVENT_OneParam(IFileManager, FAddModuleEvent, const FString &/*moduleName*/)
	virtual FAddModuleEvent& OnAddModule() = 0;
	/**
	 * Returns a delegate that is executed before a session is being selected.
	 *
	 * @return The delegate.
	 */
	DECLARE_EVENT_TwoParams(IFileManager, FCanSelectSessionEvent, const TSharedPtr<IFileInfo>& /*Session*/, bool& /*OutCanSelect*/)
	 ...
	 * @return The delegate.
	 */
	DECLARE_EVENT_TwoParams(IFileManager, FInstanceSelectionChangedEvent, const TSharedPtr<IFileInstanceInfo>& /*Instance*/, bool /*Selected*/)
	 ...
	 * @return The delegate.
	 */
	DECLARE_EVENT_ThreeParams(IFileManager, FLogReceivedEvent, const TSharedRef<IFileInfo>& /*OwnerSession*/, const TSharedRef<IFileInstanceInfo>& /*SessionInstance*/, const TSharedRef<FFileItemInfo>& /*LogMessage*/);
	 ...
	 * @return The delegate.
	 */
	DECLARE_EVENT_OneParam(IFileManager, FSelectedSessionChangedEvent, const TSharedPtr<IFileInfo>& /*SelectedSession*/)
