 ...
 */
DECLARE_DELEGATE_TwoParams(FOnContentConsoleVerbosityFilterStateChanged, ELogVerbosity::Type, bool);


/**
 * Implements a view model for a console log category filter.
 */
class FContentConsoleVerbosityFilter
	: public TSharedFromThis<FContentConsoleVerbosityFilter>
{
public:
	 ...
	 */
	FContentConsoleVerbosityFilter( ELogVerbosity::Type InVerbosity, const FSlateBrush* InIcon, bool InEnabled, const FString& InName, FOnContentConsoleVerbosityFilterStateChanged InOnStateChanged)
		: Enabled(InEnabled)
		, Icon(InIcon)
		, Name(InName)
...
private:
	...
	FOnContentConsoleVerbosityFilterStateChanged OnStateChanged;
};


/** Type definition for shared pointers to instances of FSessionConsoleVerbosityFilter. */
typedef TSharedPtr<FContentConsoleVerbosityFilter> FSessionConsoleVerbosityFilterPtr;

/** Type definition for shared references to instances of FSessionConsoleVerbosityFilter. */
typedef TSharedRef<FContentConsoleVerbosityFilter> FSessionConsoleVerbosityFilterRef;
