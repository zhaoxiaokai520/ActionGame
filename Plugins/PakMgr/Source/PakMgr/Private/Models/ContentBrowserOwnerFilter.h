 ...
 */
class FContentBrowserOwnerFilter
	: public TSharedFromThis<FContentBrowserOwnerFilter>
{
public:
	 ...
	 */
	FContentBrowserOwnerFilter( const FString& InOwnerName, bool InEnabled, FOnSessionBrowserOwnerFilterStateChanged InOnStateChanged )
		: Enabled(InEnabled)
...
typedef TSharedPtr<FContentBrowserOwnerFilter> FSessionBrowserOwnerFilterPtr;

/** Type definition for shared references to instances of FSessionBrowserOwnerFilter. */
typedef TSharedRef<FContentBrowserOwnerFilter> FSessionBrowserOwnerFilterRef;
