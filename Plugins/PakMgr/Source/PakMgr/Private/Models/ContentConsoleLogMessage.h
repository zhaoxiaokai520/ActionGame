 ...
 */
struct FContentConsoleLogMessage
{
...
public:
	 ...
	 */
	FContentConsoleLogMessage(const FMessageAddress& InSender, const FString& InInstanceName, float InTimeSeconds, const FString& InText, ELogVerbosity::Type InVerbosity, const FName& InCategory)
		: Category(InCategory)
