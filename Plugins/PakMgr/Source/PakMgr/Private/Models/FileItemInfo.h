...
/**
 * Structure for file list item.
 */
struct FFileItemInfo
{
...
public:
	 ...
	 */
	FFileItemInfo(const FGuid& InInstanceId, const FString& InInstanceName, float InTimeSeconds, const FString& InText, ELogVerbosity::Type InVerbosity, const FName& InCategory)
		: Category(InCategory)
...
public:
	...
	struct TimeComparer
	{
		bool operator()(const TSharedPtr<FFileItemInfo>& A, const TSharedPtr<FFileItemInfo>& B) const
		{
