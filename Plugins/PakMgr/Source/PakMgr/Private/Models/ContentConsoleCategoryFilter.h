 ...
 */
DECLARE_DELEGATE_TwoParams(FOnContentConsoleCategoryFilterStateChanged, const FName&, bool);


/**
 * Implements a view model for a console log category filter.
 */
class FContentConsoleCategoryFilter
	: public TSharedFromThis<FContentConsoleCategoryFilter>
{
public:
	 ...
	 */
	FContentConsoleCategoryFilter( const FName& InCategory, bool InEnabled, FOnContentConsoleCategoryFilterStateChanged InOnStateChanged )
		: Category(InCategory)
		, Enabled(InEnabled)
...
private:
	...
	FOnContentConsoleCategoryFilterStateChanged OnStateChanged;
};


/** Type definition for shared pointers to instances of FSessionConsoleCategoryFilter. */
typedef TSharedPtr<FContentConsoleCategoryFilter> FSessionConsoleCategoryFilterPtr;

/** Type definition for shared references to instances of FSessionConsoleCategoryFilter. */
typedef TSharedRef<FContentConsoleCategoryFilter> FSessionConsoleCategoryFilterRef;
